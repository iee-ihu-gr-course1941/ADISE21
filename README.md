...
Η εφαρμογή απαπτύχθηκε μέχρι το σημείο που ανακατεύει τις κάρτες, δίνει ο παίκτης ένα όνομα και του επιστρέφουμε ενα μοναδικό τόκεν στο παιχνίδι
και διαλέγει σε ποια μεριά θα παίξει. Το Game status ενημερώνεται αυτόματα ανάλογα με τις κινήσεις του παίκτη.Όλα τα στοιχεία του πίνακα τα παίρνουμε
απο την βάση μας με όνομα πίνακα cards_board.
...
```
Κάνει προσθήκη τα στοιχεία του παίκτη στη βάση μας και μετά ζητάει να γίνει είσοδος στο παιχνίδι με αυτά.
## Entities
...
| `last_action`            | Ενημερώνει την ημέρα και την ώρα από την τελευταία κίνηση του παίκτη    | timestamp|
...
Τα στοιχεία του παίκτη είναι:

| Attribute                | Description                                  | Values                              |
| ------------------------ | -------------------------------------------- | ----------------------------------- |
| `idplayers `             | Πόσοι παίκτες έχουν γίνει μέλη στην ιστοσελιδα μας              | auto increment |
| `firstname`              | Το όνομα χρήστη        		      | varchar                         |
| `lastname`               | Το επίθετο του χρήστη       		 | varchar                              |
| `email`            	   | Το email του  						    | timestamp |
| `username `              | Το username που θα χρησιμοποιεί και στην είσοδό του στην ιστοσελίδα        | varchar    |
| `password`               | Το password που θα χρειάζεται για να εισέλθει στην ιστοσελίδα      | password (md5)               |
